...
import year2018to2019semster2.game.UserInterface;
...
{   // Curly brackets DO NOT remove
    ...
    private static void learnClasses() {
        ...
        String[] courses = {
            "Math", "Computer Science", "Metal Smithing", "Basket Weaving"
        };        
        Student student = new Student("Tasha Beifini",17,false,courses);
        student.talk();
        student.study(8);
        student.slackOff();
        student.cram();
