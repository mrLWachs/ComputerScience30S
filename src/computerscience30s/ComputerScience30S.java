...
public class ComputerScience30S {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        JOptionPane.showMessageDialog(null, r + " as a int is " + s);
        ...
        JOptionPane.showMessageDialog(null, t + " as a double is " + u);
        
        // Example with a char (single character)...
        
        String v = JOptionPane.showInputDialog("Enter a char");
        char   w = v.charAt(0);
        JOptionPane.showMessageDialog(null, "char at 0 is " + w);
        ...
        System.out.println(word + " in uppercase is " + upper);
        ...
        // if (word1 == word2) ---> NOT CORRECT CODE FOR STRINGS
        ...
        for (int counting = 1; counting <= 100; counting = counting + 1) {
