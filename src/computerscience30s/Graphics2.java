...
/**
 * Graphics2.java - this "class" was just added as a "New Class" (not a 
 * "New JFrame form" and we put in all the code ourselves (with copy and
 * paste) it is the beginning of making a container (the frame) and 
 * various controls (button, labels, textbox) inside of it. This class uses 
 * inheritance to inherit the properties and methods from the JFrame class. 
 * This means this class is the child (sub-class) of the parent class (super 
 * class, base class). This is sometimes simplified to a "is a" relationship
 *
 * @author Mr. Wachs
 * @since May 2026
 */
public class Graphics2 extends JFrame 
{
    ...
    private JButton    exitButton;                    // "Command button" in C#
    private JLabel     pictureLabel;     // There are other ways to show images
    private JTextField textField;                            // A text box area
    private JLabel     textLabel;     // Label can be for text, images, or both
    ...
    private void setControls() {
        ...
        textLabel    = new JLabel();      // Calls the JLabel constructor method
        ...
        exitButton.setText("ENTER");
        // With image, little more code, why not "take" (copy/paste) the
        // code from the designer and adapt it as you like
        final String FILE = "/computerscience30s/creepy.gif";
        pictureLabel.setIcon(new ImageIcon(getClass().getResource(FILE))); 
    ...
    private void setActions() {
        ...
        textField.addKeyListener( new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                textLabel.setText("Key pressed: " + e.getKeyCode());
            }
    ...
    private void mouseMoving(MouseEvent event) {
        textLabel.setText("Mouse over image: " + event.getX() + "," + event.getY());
    }
    ...
    private void mouseOver(boolean state) {
        if (state == true) textLabel.setText("Mouse has entered");
        else               textLabel.setText("Mouse has left");        
